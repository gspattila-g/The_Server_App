...
class ProfileService {
  ...
  Future<String> uploadProfileImage(String uid, File imageFile) async {
    try {
      ...
      print('Hiba a profilkép feltöltésekor: $e');
      rethrow;
    }
  }
  ...
  Future<void> createProfile(UserProfile userProfile) async {
    try {
      ...
      print('Hiba a profil létrehozásakor: $e');
      rethrow;
    }
  }
  ...
  Future<UserProfile?> getProfile(String uid) async {
    try {
      ...
      print('Hiba a profil lekérésekor: $e');
      rethrow;
    }
  }
  ...
  Future<void> updateProfile(UserProfile userProfile) async {
    try {
      ...
      print('Hiba a profil frissítésekor: $e');
      rethrow;
    }
  }
  ...
  Future<void> deleteProfile(String uid) async {
    try {
      ...
      print('Hiba a profil törlésekor: $e');
      rethrow;
    }
  }
